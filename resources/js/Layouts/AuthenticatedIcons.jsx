...
export default function AuthenticatedIcons({ user, auth }) {
    ...
    if (isMobile) {
        return (
            // Render a different section for mobile
            <div className="mobile-section">
                <div className="flex flex-row justify-between items-center px-4">
                    <p className="text-red-600">AppetiteConnect</p>
        ...
        return (
            <div className="flex flex-row md:justify-center md:self-center justify-start px-3">
                <Link className="px-2">
                    <svg
                ...
                <Link href={route("profile.edit")} className="px-2">
                    <svg
                        width="30px"
                        height="30px"
                        viewBox="0 0 24 24"
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                    >
                        <circle cx="12" cy="12" r="3" stroke="red" />
                        <path
